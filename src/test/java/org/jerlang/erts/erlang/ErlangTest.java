...
public class ErlangTest {
    ...
    public void testLength1() {
        ...
        assertEquals(zero, Erlang.length_1(List.nil));
        assertEquals(zero, Erlang.length_1(List.of()));
        assertEquals(Integer.of(1), Erlang.length_1(List.of(zero)));
        assertEquals(Integer.of(2), Erlang.length_1(List.of(zero, zero)));
    }
